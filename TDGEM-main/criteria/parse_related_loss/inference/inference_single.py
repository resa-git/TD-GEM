...
def read_img(img_path):
    _img = Image.open(img_path.replace('\n','')).convert('RGB')  # return is RGB pic
    return _img
...
if __name__ == '__main__':
    ...
    parser.add_argument('--loadmodel', default='./pretrained/deeplabv3plus-xception-vocNov14_20-51-38_epoch-89.pth', type=str)
    parser.add_argument('--img_list', default='./demo_imgs/img_list.txt', type=str)
    parser.add_argument('--output_dir', default='../results/masking', type=str)
