...
class TrainOptions:
	...
	def initialize(self):
		self.parser.add_argument('--exp_dir', type=str, default= '../results/mapper', help='Path to experiment output directory')
		...
		self.parser.add_argument('--train_dataset_size', default=2, type=int, help="Will be used only if no latents are given")
		self.parser.add_argument('--test_dataset_size', default=2, type=int, help="Will be used only if no latents are given")
		...
		self.parser.add_argument('--id_lambda', default=0.8, type=float, help='ID loss multiplier factor')
		...
		self.parser.add_argument('--stylegan_weights', default='../pretrained_models/stylegan_human_v2_1024.pth', type=str, help='Path to StyleGAN model weights')
		...
		self.parser.add_argument('--description', default="A long sleeve", required=False, type=str, help='Driving text prompt')#A really long sleeve#A blue dress
