...
checkpoints_dir = './outputs/ds_200/checkpoints'
embedding_base_dir = './outputs/ds_200/embeddings'
experiments_output_dir = './outputs/ds_200'

## Input info
### Input dir, where the images reside
#input_data_path = 'aligned_image/'
input_data_path = '../../dataset/ds_200'
