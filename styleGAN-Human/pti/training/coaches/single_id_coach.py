...
# Copyright (c) SenseTime Research. All rights reserved.
            ...
            if hyperparameters.max_pti_steps > 0:
                # save output image
                ...
                save_image(generated_images, f"{paths_config.experiments_output_dir}/{image_name}.jpg", normalize=True)
                self.image_counter += 1
                print("img ", fname, " pti loss: ", i, loss.data, loss_lpips.data)
                ...
                generated_images = self.forward(w_pivot)
                tmp = torch.cat([real_images_batch, generated_images, generated_images], axis= 3)
                save_image(tmp, f"{paths_config.experiments_output_dir}/{image_name}.png", normalize=True)
                self.image_counter += 1
                #print("img ", fname)
